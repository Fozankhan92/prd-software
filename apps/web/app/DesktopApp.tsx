...
const moduleContent: Record<string, { eyebrow: string; title: string; summary: string; actions: string[]; metrics?: string[] }> = {
     ...
     scm: { eyebrow: "Spply network", title: "SCM workbench", summary: "Track suppliers, shipments, lead times, receiving, and delivery exceptions.", actions: ["New shipment", "Track delivery", "View exceptions"] },
