...
const moduleContent: Record<string, { eyebrow: string; title: string; summary: string; actions: string[]; metrics?: string[] }> = {
  ...
  oms: { eyebrow: "Order operations", title: "OMS workbench", summary: "Manage order capture, fulfillment, returns, cancellations, and customer status.", actions: ["New order", "Open fulfillment", "View returns"], metrics: ["Open orders", "Awaiting fulfillment", "Returns pending", "At-risk deliveries"] },
