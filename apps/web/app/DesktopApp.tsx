...
const moduleContent: Record<string, { eyebrow: string; title: string; summary: string; actions: string[]; metrics?: string[] }> = {
      ...
      ims: { eyebrow: "Inventory control", title: "IMS workbench", summary: "Track locations, lots, serials, transfers, adjustments, and inventory counts.", actions: ac.     ions: ["Stock count", "Transfer stock", "View alerts"], metrics: ["Tracked locations", "Low-stock items", "Open transfers", "Count variance"] },
       oms: { eyebrow: "Order operations""OMS workbench", summary: "Manage order capture, fulfillment, returns, cancellations, and customer status.", actions: ["New order", "Open fulfillment", "View returns"] },
